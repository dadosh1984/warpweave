 ...
 *
 * Superpowers TDD: RED-GREEN-REFACTOR, subagent-driven development, and
 * two-stage review.
 */
import type { SkillTemplate } from '../types.js';
import { STORE_SELECTION_GUIDANCE } from './store-selection.js';

export function getSuperpowersTddSkillTemplate(): SkillTemplate {
  return {
    ...
    instructions: `Implement tasks test-first.
