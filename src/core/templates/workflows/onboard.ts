...
function getOnboardInstructions(): string {
  return `Guide the user through their first complete Warpweave workflow cycle. This is a teaching experience—you'll do real work in their codebase while explaining each step.
