...
> Spectrix CLI is not installed. Install it first, then come back to \`/opsx:onboard\`.
...
- \`/opsx:continue <name>\` - Resume artifact creation (if installed; otherwise \`spectrix status --change "<name>" --json\` shows the next artifact)
