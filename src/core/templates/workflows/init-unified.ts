...
**Input**: A target directory after \`/opsx:init-unified\` (defaults to the current project root). If a project is already initialized, confirm before re-running.
