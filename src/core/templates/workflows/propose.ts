...
When ready to implement, run /ww:apply
...
**Input**: The argument after \`/ww:propose\` is the change name (kebab-case), OR a description of what the user wants to build.
