...
- \`/opsx:continue\` and \`/opsx:new\` may not be installed (core profile). When suggesting one that is unavailable, point to the CLI instead: \`spectrix status --change "<name>" --json\` shows the next artifact and \`spectrix instructions <artifact-id> --change "<name>" --json\` explains how to create it.`,
    license: 'MIT',
