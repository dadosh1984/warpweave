...
**Input**: A change name after \`/opsx:benchmark\` (e.g., \`/opsx:benchmark add-auth\`). If omitted, infer from conversation context; if ambiguous, prompt for available changes.
