...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about Warpweave with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about Warpweave.
...
5. **Submit on confirmation**
   - Use the \`warpweave feedback\` command to submit
   - Format: \`warpweave feedback "title" --body "body content"\`
