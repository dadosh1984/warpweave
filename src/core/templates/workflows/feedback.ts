...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about Spectrix with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about Spectrix.
...
5. **Submit on confirmation**
   - Use the \`spectrix feedback\` command to submit
   - Format: \`spectrix feedback "title" --body "body content"\`
