...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'warpweave';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'warpweave';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/warpweave/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/warpweave/
 * - Windows fallback: %APPDATA%/warpweave/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/warpweave/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/warpweave/
 * - Windows fallback: %LOCALAPPDATA%/warpweave/
 */
