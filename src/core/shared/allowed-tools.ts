 ...
 * same field for Claude Code slash commands). Scoped to the Warpweave CLI so
 * agents that honor it stop prompting on each `warpweave` call; the field
 ...
 */
export const WARPWEAVE_CLI_ALLOWED_TOOLS = 'Bash(warpweave:*)';
