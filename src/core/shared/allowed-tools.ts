 ...
 * same field for Claude Code slash commands). Scoped to the Spectrix CLI so
 * agents that honor it stop prompting on each `spectrix` call; the field
 ...
 */
export const OPENSPEC_CLI_ALLOWED_TOOLS = 'Bash(spectrix:*)';
