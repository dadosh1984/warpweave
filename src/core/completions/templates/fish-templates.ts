...
function __fish_spectrix_using_subcommand
...
function __fish_spectrix_no_subcommand
    set -l cmd (commandline -opc)
    test (count $cmd) -eq 1
end`;
...
function __fish_spectrix_items
    __fish_spectrix_changes
    __fish_spectrix_specs
end
