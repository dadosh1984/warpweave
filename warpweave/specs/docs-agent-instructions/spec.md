...
- **WHEN** `warpweave/AGENTS.md` is regenerated or updated
...
`warpweave/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`warpweave/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `warpweave validate`.
...
- **WHEN** reorganizing `warpweave/AGENTS.md`
...
- **WHEN** `warpweave/AGENTS.md` explains how to write `spec.md`
