---
name: warpweave-translator
description: Turn underspecified user requests into clearly-specified ones before implementing. Use when a request has multiple plausible interpretations or key details (objective, scope, constraints, environment, or safety) are unclear.
...
Turn what the user wrote into what the AI will clearly understand.
...
If the user is formulating a new change request, suggest running `/warpweave-propose` to create the change and generate all artifacts. For other kinds of requests, just proceed.
