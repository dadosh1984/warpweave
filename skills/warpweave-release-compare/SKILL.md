...
Compare the project's state after a release against the previous release, score the improvement, and warn when it falls short of a configured minimum threshold.
