...
```text
0:00  $ openspec init
      ✓ Done. Run /otrix:propose "your idea"

0:15  /otrix:propose "add user authentication"
...
`/otrix:propose` should naturally onboard users by explaining what it's doing:
