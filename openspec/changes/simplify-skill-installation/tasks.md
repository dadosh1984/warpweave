...
- [x] 7.6 Update success message to show `/otrix:propose` prompt (only if propose is in the active profile)
...
- [x] 8.4 Display migration message: "Migrated: custom profile with N workflows" + "New in this version: /otrix:propose. Try 'openspec config profile core' for the streamlined experience."
...
- [x] 11.1 Audit all templates for hardcoded cross-workflow command references (e.g., `/otrix:propose`)
