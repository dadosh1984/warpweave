...
- **THEN** the system SHALL display: "New in this version: /otrix:propose (combines new + ff). Try 'openspec config profile core' for the streamlined 4-workflow experience."
