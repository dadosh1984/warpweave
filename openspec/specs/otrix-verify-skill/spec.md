# otrix-verify-skill Specification

## Purpose
Define `/otrix:verify` behavior for assessing implementation completeness, correctness, and coherence against change artifacts.
