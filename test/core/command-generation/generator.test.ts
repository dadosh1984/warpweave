...
describe('command-generation/generator', () => {
  ...
  describe('generateCommand', () => {
    it('should generate command with path and content using Claude adapter', () => {
      ...
      expect(result.fileContent).toContain('name: "Spectrix Explore"');
    ...
    it('should generate command for Cursor adapter', () => {
      ...
      expect(result.path).toContain('otrix-explore.md');
      expect(result.fileContent).toContain('name: "/otrix-explore"');
      expect(result.fileContent).toContain('id: "otrix-explore"');
      expect(result.fileContent).toContain('Command body here.');
    });
    ...
    it('should work with custom adapter', () => {
      ...
      expect(result.fileContent).toBe('# Spectrix Explore\n\nCommand body here.');
    });
  });
