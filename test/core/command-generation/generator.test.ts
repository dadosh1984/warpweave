...
describe('command-generation/generator', () => {
  ...
  describe('generateCommand', () => {
    it('should generate command with path and content using Claude adapter', () => {
      ...
      expect(result.fileContent).toContain('name: "Warpweave Explore"');
    ...
    it('should generate command for Cursor adapter', () => {
      ...
      expect(result.path).toContain('ww-explore.md');
      expect(result.fileContent).toContain('name: "/ww-explore"');
      expect(result.fileContent).toContain('id: "ww-explore"');
      expect(result.fileContent).toContain('Command body here.');
    });
    ...
    it('should work with custom adapter', () => {
      ...
      expect(result.fileContent).toBe('# Warpweave Explore\n\nCommand body here.');
    });
  });
