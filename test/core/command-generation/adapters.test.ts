...
describe('command-generation/adapters', () => {
  ...
  describe('claudeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.claude', 'commands', 'ww', 'explore.md'));
    });

    it('should generate correct file path for different command IDs', () => {
      expect(claudeAdapter.getFilePath('new')).toBe(path.join('.claude', 'commands', 'ww', 'new.md'));
      expect(claudeAdapter.getFilePath('bulk-archive')).toBe(path.join('.claude', 'commands', 'ww', 'bulk-archive.md'));
    });
    ...
    it('should format file with correct YAML frontmatter', () => {
      ...
      expect(output).toContain('name: "Warpweave Explore"');
      expect(output).toContain('description: "Enter explore mode for thinking"');
      expect(output).toContain('allowed-tools: Bash(warpweave:*)');
  ...
  describe('cursorAdapter', () => {
    ...
    it('should generate correct file path with ww- prefix', () => {
      const filePath = cursorAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.cursor', 'commands', 'ww-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(cursorAdapter.getFilePath('new')).toBe(path.join('.cursor', 'commands', 'ww-new.md'));
      expect(cursorAdapter.getFilePath('bulk-archive')).toBe(path.join('.cursor', 'commands', 'ww-bulk-archive.md'));
    });
    ...
    it('should format file with Cursor-specific frontmatter', () => {
      ...
      expect(output).toContain('---\n');
      expect(output).toContain('name: "/ww-explore"');
      expect(output).toContain('id: "ww-explore"');
      expect(output).toContain('category: "Workflow"');
      expect(output).toContain('description: "Enter explore mode for thinking"');
      expect(output).toContain('---\n\n');
      expect(output).toContain('This is the command body.');
  ...
  describe('devinAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.devin', 'workflows', 'ww-explore.md'));
    });
    ...
    // The body's `/ww:*` references are rewritten to the `/ww-*` form
  ...
  describe('amazonQAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.amazonq', 'prompts', 'ww-explore.md'));
    });
  ...
  describe('antigravityAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.agent', 'workflows', 'ww-explore.md'));
    });
  ...
  describe('auggieAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.augment', 'commands', 'ww-explore.md'));
    });
  ...
  describe('bobAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.bob', 'commands', 'ww-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(bobAdapter.getFilePath('new')).toBe(path.join('.bob', 'commands', 'ww-new.md'));
      expect(bobAdapter.getFilePath('bulk-archive')).toBe(path.join('.bob', 'commands', 'ww-bulk-archive.md'));
    });
    ...
    it('is generated by generateCommand with hyphen command references', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /ww:apply to implement. Then use /ww:verify.',
      };
      const output = generateCommand(contentWithRefs, bobAdapter).fileContent;
      expect(output).toContain('/ww-apply');
      expect(output).toContain('/ww-verify');
      expect(output).not.toContain('/ww:apply');
      expect(output).not.toContain('/ww:verify');
    });
  ...
  describe('codebuddyAdapter', () => {
    ...
    it('should generate correct file path with nested ww folder', () => {
      const filePath = codebuddyAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.codebuddy', 'commands', 'ww', 'explore.md'));
    });
  ...
  describe('continueAdapter', () => {
    ...
    it('should generate correct file path with .prompt extension', () => {
      ...
      expect(filePath).toBe(path.join('.continue', 'prompts', 'ww-explore.prompt'));
    });
  ...
  describe('costrictAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.cospec', 'warpweave', 'commands', 'ww-explore.md'));
    });
  ...
  describe('crushAdapter', () => {
    ...
    it('should generate correct file path with nested ww folder', () => {
      ...
      expect(filePath).toBe(path.join('.crush', 'commands', 'ww', 'explore.md'));
    });
  ...
  describe('factoryAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.factory', 'commands', 'ww-explore.md'));
    });
  ...
  describe('geminiAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.gemini', 'commands', 'ww', 'explore.toml'));
    });
  ...
  describe('githubCopilotAdapter', () => {
    ...
    it('should generate correct file path with .prompt.md extension', () => {
      ...
      expect(filePath).toBe(path.join('.github', 'prompts', 'ww-explore.prompt.md'));
    });
  ...
  describe('iflowAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.iflow', 'commands', 'ww-explore.md'));
    });
  ...
  describe('kilocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.kilocode', 'workflows', 'ww-explore.md'));
    });
  ...
  describe('opencodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.opencode', 'commands', 'ww-explore.md'));
    });
    ...
    it('is generated by generateCommand with every reference hyphenated', () => {
      const contentWithMultipleCommands: CommandContent = {
        ...sampleContent,
        body: `/ww:explore for ideas
/ww:new to create
/ww:continue to proceed
/ww:apply to implement`,
      };
      const output = generateCommand(contentWithMultipleCommands, opencodeAdapter).fileContent;
      expect(output).toContain('/ww-explore');
      expect(output).toContain('/ww-new');
  ...
  describe('qoderAdapter', () => {
    ...
    it('should generate correct file path with nested ww folder', () => {
      ...
      expect(filePath).toBe(path.join('.qoder', 'commands', 'ww', 'explore.md'));
    });
  ...
  describe('qwenAdapter', () => {
    ...
    it('should generate correct file path with .md extension', () => {
      ...
      expect(filePath).toBe(path.join('.qwen', 'commands', 'ww-explore.md'));
    });
    ...
    it('is generated by generateCommand with hyphen command references', () => {
      // Qwen commands are invoked by filename (/ww-<id>), like bob/opencode.
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /ww:apply to implement. Then use /ww:archive.',
      };
      const output = generateCommand(contentWithRefs, qwenAdapter).fileContent;
      expect(output).toContain('/ww-apply');
      expect(output).toContain('/ww-archive');
      expect(output).not.toContain('/ww:apply');
      expect(output).not.toContain('/ww:archive');
    });
  });
  ...
  describe('piAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.pi', 'prompts', 'ww-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(piAdapter.getFilePath('new')).toBe(path.join('.pi', 'prompts', 'ww-new.md'));
      expect(piAdapter.getFilePath('bulk-archive')).toBe(path.join('.pi', 'prompts', 'ww-bulk-archive.md'));
    });
    ...
    it('is generated by generateCommand with hyphen command references', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /ww:apply to implement. Then /ww:archive when done.',
      };
    ...
    it('should inject template arguments into the input section', () => {
      const contentWithInput: CommandContent = {
        ...sampleContent,
        body: '**Input**: The argument after `/ww:explore` is the topic.\n\n**Steps**\n1. Think.',
      };
  ...
  describe('ohMyPiAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.omp', 'commands', 'ww-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(ohMyPiAdapter.getFilePath('new')).toBe(path.join('.omp', 'commands', 'ww-new.md'));
      expect(ohMyPiAdapter.getFilePath('bulk-archive')).toBe(path.join('.omp', 'commands', 'ww-bulk-archive.md'));
    });
  ...
  describe('roocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.roo', 'commands', 'ww-explore.md'));
    });
  ...
  describe('traeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.trae', 'commands', 'ww-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(traeAdapter.getFilePath('new')).toBe(path.join('.trae', 'commands', 'ww-new.md'));
      expect(traeAdapter.getFilePath('bulk-archive')).toBe(path.join('.trae', 'commands', 'ww-bulk-archive.md'));
    });
  ...
  describe('zcodeAdapter', () => {
    ...
    it('should generate correct file path under .zcode/commands/ww', () => {
      const filePath = zcodeAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.zcode', 'commands', 'ww', 'explore.md'));
    });

    it('should generate correct file paths for different command IDs', () => {
      expect(zcodeAdapter.getFilePath('new')).toBe(path.join('.zcode', 'commands', 'ww', 'new.md'));
      expect(zcodeAdapter.getFilePath('bulk-archive')).toBe(path.join('.zcode', 'commands', 'ww', 'bulk-archive.md'));
    });
  ...
  describe('cross-platform path handling', () => {
    it('Claude adapter uses path.join for paths', () => {
      ...
      expect(filePath.split(path.sep)).toEqual(['.claude', 'commands', 'ww', 'test.md']);
    });

    it('Cursor adapter uses path.join for paths', () => {
      const filePath = cursorAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.cursor', 'commands', 'ww-test.md']);
    });

    it('Devin adapter uses path.join for paths', () => {
      const filePath = devinAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.devin', 'workflows', 'ww-test.md']);
    });
