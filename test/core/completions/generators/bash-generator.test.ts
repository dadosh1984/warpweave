...
describe('BashGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid bash completion script with header', () => {
      ...
      expect(script).toContain('# Bash completion script for Warpweave CLI');
      expect(script).toContain('_warpweave_completion() {');
    ...
    it('should generate script that ends with complete registration', () => {
      ...
      expect(script.trim().endsWith('complete -F _warpweave_completion warpweave')).toBe(true);
    });
    ...
    it('should handle empty command list', () => {
      ...
      expect(script).toContain('_warpweave_completion() {');
      expect(script).toContain('complete -F _warpweave_completion warpweave');
    });
