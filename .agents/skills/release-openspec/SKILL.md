...
5. Use the exact package name `"@dadosh1984/spectrix"`, the highest required semantic bump, only relevant headings, and user-focused descriptions.
...
2. Verify all three artifacts independently:
   - `npm view @dadosh1984/spectrix@<version> version`
